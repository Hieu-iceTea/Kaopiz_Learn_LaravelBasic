...
<head>
    ...
    <title>Admin - @yield('title') | Kaopiz_Learn_LaravelBasic</title>

    <!-- Favicons -->
    <link rel="shortcut icon" href="/favicon_shirt.png" type="image/x-icon">
                    ...
                    <ul class="vertical-nav-menu">
                        ...
                        <li class="mm-active">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="./admin/post" class="{{ (request()->segment(2) == 'post') ? 'mm-active' : '' }}">
